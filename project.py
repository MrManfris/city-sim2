...
def build(city, building_type):
    ...
    elif city.type == "klaipeda":
        names_map = {
            "house": "Irštva",
            "factory": "Gintaro kasyklos",
            "Ekologiški namai": "Žalioji irštva",
            "Vėjo jėgainės": "Oro maišintuvai",
            "Viesbutis": "Klaiki pėda",
            "kat_malsintojas": "Skausmo_malsintojas"
...
def kita_diena(city):
    global income
    income = 0
    fabrikai = ["Fabrikas", "Trišakių darykla", "Saw cleaverių darykla", "Gintaro kasyklos"]
...
while True:
    ...
    if city.type == "atlantida":
        ...
        print("\nVeiksmai:")
        print("1 - Statyti Irštvą (50)")
        print("2 - Statyti Gintaro kasyklas (100)")
        print("4 - Statyti Žaliąsias irštvas(75)")
        print("5 - Statyti Oro maišintuvai (50)")
        print("6 - Statyti Klaikią pėdą (150)")
        print("7 - Statyti Skausmo malšintoją (200)")
        print("\nSkill tree")
        print("8 - pastatu kainos I (200) Mažina pastatų kainas ant 10%")
        print("9 - pastatu kainos II (600) Reikia turėti Pastatu kainos I. Mažina pastatų kainas ant 35% ")
        print("10 - ekologija I (100) Mažina fabriku išleidžiama taršą ant 10")
    ...
    if choice == "1":
        ...
        secret_ending3(city)
        city.type = "klaipeda"
        input("Paspausk ENTER, kad tęsti žaidimą Klaipėdoje")
    ...
    if city.type == "klaipeda" and city["diena"] == 100:
        ...
        break
    if city.type == "atlantida" and city["diena"] == 100:
        print(f"\nKai prasidėjo 100-oji diena jūs pamatėte, kad Poseidonas grįžo į Atlantidą ir ėjo pas jus.\n Atėjęs jis jums pasakė, kad dievai žiūrėjo, kaip jūs valdote ir nusprendė jūs paversti dievu.\n Net nespėjote padėkoti, kaip jūs atsiradote Olimpe ir jau buvot dievu.\n Jums iki šiol nežinoma, kaip jūs patapote dievu, nes atsirade Olimpe jūs gulėjote šventykloje kur vykdo ritualus. Turbūt ritualo būdu jūs tapote dievu kas žino, kas žino... \nIšlaikėtė miestą {city["diena"]} dienų.\n Turėjote {city["pinigai"]} pinigų.\n Jūsų miesto gyventojų pajamos: {income}.\n Štai kokius pastatus turėjote: {counts}.\n Dievai dėkoja jum už pagalbą išlaikant Atlantidą!")
        break
    if city.type == "yharnam" and city["diena"] == 100:
        print(f"\nPraėjus 99 dienai jūs einat gulti ir, kai ant laikrodžių sumušė 12 val. nakties ir prasidėjo 100-oji diena jūs atsikėlėte ir pamatėtė naktis nesibaigė ir jūs supratot...\n Prasidėjo medžioklinė naktis!\n Jūs net nespėjote tai suprasti, kai jums iš nugaros įsmeigė su saw cleveriu ir jūs gulėjote mires ant grindų ir iš jūsų bėgo ir vis bėgo kraujas.\n Jūsų istorija baigėsi ir jūsų kūnas taip ir gulės ant grindų, kol nesibaigs naktis. Bet ar ji pasibaigs ?\n Išlaikėtė miestą {city["diena"]} dienų.\n Turėjote {city["pinigai"]} pinigų.\n Jūsų miesto gyventojų pajamos: {income}.\n Štai kokius pastatus turėjote: {counts}.\n Ačiū, kad išlaikėte miestą iki medžioklines nakties!  ")
        break
    if city["tarša"] >= 100:
